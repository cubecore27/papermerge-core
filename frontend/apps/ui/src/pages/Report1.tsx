    ...
    <div className={styles.reportPage}>
      ...
      <section className={styles.exportSection}>
        ...
        <div className={styles.buttonGroup}>
          <button className={styles.exportButton} title='Download Full Activity Report (CSV)'>Download Full Activity Report (CSV)</button>
          <button className={styles.exportButton} title='Download Import/Export Logs (CSV)'>Download Import/Export Logs (CSV)</button>
        </div>
      </section>
    </div>
  );
